namespace FreeLauncher
{
    public class ApplicationLocalization
    {
        ...
        public string GratitudesDescription { get; set; } = "Noseqe :V!";
        public string PartnersText { get; set; } = "Asociados";
        public string MCofflineDescription { get; set; } = "[RUS] MCoffline - the best software for server administrators!";
